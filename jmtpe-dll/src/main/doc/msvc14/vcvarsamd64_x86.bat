...
@if NOT "%VS140COMNTOOLS%"=="" goto okqueryregistry
set VSINSTALLDIR=C:\Developpement\vstudio\vs2015\
set WindowsSdkBaseDir=%ProgramFiles(x86)%\Windows Kits\
...
set WindowsSdkDir=%WindowsSdkBaseDir%8.1\
set WindowsLibPath=%WindowsSdkDir%References\CommonConfiguration\Neutral
set UniversalCRTSdkDir=%WindowsSdkBaseDir%10\
...
set NETFXSDKDir=%WindowsSdkBaseDir%NETFXSDK\4.6.1\
set WindowsSDK_ExecutablePath_x64=%WindowsSdkBaseDir%Windows\v10.0A\bin\NETFX 4.6.1 Tools\x64\
set WindowsSDK_ExecutablePath_x86=C%WindowsSdkBaseDir%Windows\v10.0A\bin\NETFX 4.6.1 Tools\
goto postqueryregistry

:okqueryregistry
@if "%VS140COMNTOOLS%"=="" goto error_no_VS140COMNTOOLSDIR

@call "%VS140COMNTOOLS%VCVarsQueryRegistry.bat" 64bit 32bit %1 %2
:postqueryregistry
